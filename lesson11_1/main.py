...
import tools
#from tools import getRandom,saveToCSV
...
if __name__ == '__main__':
    ...
    #隨機抽n個人
    result = tools.getRandom(csv_name,get_name_cnt)
    print(f"隨機抽{get_name_cnt}個人結果:")
    print(result)

    #每個人隨機放n個分數
    data = tools.putRandomInt(result, get_sbj_cnt)
    ...
    if tools.saveToCSV(fileName,title,data):
        print("存檔成功!")
    else:
        print("存檔失敗")
